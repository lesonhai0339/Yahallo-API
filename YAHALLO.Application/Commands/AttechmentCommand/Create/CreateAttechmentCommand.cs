...
namespace YAHALLO.Application.Commands.AttechmentCommand.Create
{
    ...
    {
        public CreateAttechmentCommand(string? blogid, string? commentid,bool isHaveMedia, string? description, CommentMediaType? mediaType, FileUploadInfo? mediaFile, string? title, string? url1, string? url2, string? url3)
        {
            BlogId = blogid;
            CommentId = commentid;
        ...
        public FileUploadInfo? MediaFile { get; set; }
