...
{
    public class DeleteChapterCommandHandler : IRequestHandler<DeleteChapterCommand, ResponeResult>
    {
        ...
        public async Task<ResponeResult> Handle(DeleteChapterCommand request, CancellationToken cancellationToken)
        {
