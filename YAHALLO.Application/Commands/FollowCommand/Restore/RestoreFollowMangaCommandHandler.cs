...
{
    public class RestoreFollowMangaCommandHandler : IRequestHandler<RestoreFollowMangaCommand, ResponseResult<string>>
    {
        ...
        public async Task<ResponseResult<string>> Handle(RestoreFollowMangaCommand request, CancellationToken cancellationToken)
        {
