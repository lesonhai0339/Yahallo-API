...
{
    public class DeleteFollowMangaCommandHandler : IRequestHandler<DeleteFollowMangaCommand, ResponseResult<string>>
    {
        ...
        public async Task<ResponseResult<string>> Handle(DeleteFollowMangaCommand request, CancellationToken cancellationToken)
        {
