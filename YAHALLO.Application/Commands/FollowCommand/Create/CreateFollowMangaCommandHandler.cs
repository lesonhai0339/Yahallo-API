...
{
    public class CreateFollowMangaCommandHandler : IRequestHandler<CreateFollowMangaCommand, ResponeResult>
    {
        ...
        public async Task<ResponeResult> Handle(CreateFollowMangaCommand request, CancellationToken cancellationToken)
        {
