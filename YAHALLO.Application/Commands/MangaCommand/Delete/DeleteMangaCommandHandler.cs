...
{
    public class DeleteMangaCommandHandler : IRequestHandler<DeleteMangaCommand, ResponeResult>
    {
        ...
        public async Task<ResponeResult> Handle(DeleteMangaCommand request, CancellationToken cancellationToken)
        {
