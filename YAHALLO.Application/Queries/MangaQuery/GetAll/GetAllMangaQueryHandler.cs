...
{
    public class GetAllMangaQueryHandler : IRequestHandler<GetAllMangaQuery, List<MangaDto>>
    {
        private readonly IMangaRepository _mangaRepository;
        private readonly IMapper _mapper;
        public GetAllMangaQueryHandler(IMangaRepository mangaRepository, IMapper mapper)
        {
            _mangaRepository = mangaRepository;
            _mapper = mapper;
        }

        public async Task<List<MangaDto>> Handle(GetAllMangaQuery request, CancellationToken cancellationToken)
        {
