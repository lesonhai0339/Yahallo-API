...
{
    public class GetAllDeletedRatingPaginationQueryValidator: AbstractValidator<GetAllDeletedRatingPaginationQuery>
    {
        public GetAllDeletedRatingPaginationQueryValidator()
        {
