...
{
    public class GetAllUserRoleQueryHandler : IRequestHandler<GetAllUserRoleQuery, List<UserRoleDto>>
    {
        ...
        public async Task<List<UserRoleDto>> Handle(GetAllUserRoleQuery request, CancellationToken cancellationToken)
        {
