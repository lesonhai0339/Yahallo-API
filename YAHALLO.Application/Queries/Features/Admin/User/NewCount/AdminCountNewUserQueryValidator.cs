...
{
    public sealed class CountNewUserQueryValidator: AbstractValidator<CountNewUserQuery>
    {
        public CountNewUserQueryValidator()
        {
            ...
            RuleFor(x => x).Must(x =>
    x.CountBy != UserCountBy.Day || (x.To - x.From).Days <= 366)
