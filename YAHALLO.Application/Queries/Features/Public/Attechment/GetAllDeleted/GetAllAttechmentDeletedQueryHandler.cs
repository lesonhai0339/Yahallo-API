...
namespace YAHALLO.Application.Queries.Features.Public.Attechment.GetAllDeleted
{
    public class GetAllAttechmentDeletedQueryHandler : IRequestHandler<GetAllAttechmentDeletedQuery, ResponseResult<AttechmentDto>>
    {
        ...
        {
            var chechAttechmentExist = await _attechmentRepository.FindAllAsync(x => x.DeleteDate.HasValue, cancellationToken, ignoreQueryFilters: true);
