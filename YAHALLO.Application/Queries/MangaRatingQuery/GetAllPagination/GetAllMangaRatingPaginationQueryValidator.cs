...
{
    public class GetAllMangaRatingPaginationQueryValidator: AbstractValidator<GetAllMangaRatingPaginationQuery> 
    {
        public GetAllMangaRatingPaginationQueryValidator()
        {
