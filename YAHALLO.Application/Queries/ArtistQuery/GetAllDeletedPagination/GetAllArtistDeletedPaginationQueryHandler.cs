...
{
    public class GetAllArtistDeletedPaginationQueryHandler : IRequestHandler<GetAllArtistDeletedPaginationQuery, PagedResult<ArtistDto>>
    {
        private readonly IArtistRepository _artistRepository;
        private readonly IMapper _mapper;
        public GetAllArtistDeletedPaginationQueryHandler(IArtistRepository artistRepository, IMapper mapper)
        {
            _artistRepository = artistRepository;
            _mapper = mapper;
        }
        public async Task<PagedResult<ArtistDto>> Handle(GetAllArtistDeletedPaginationQuery request, CancellationToken cancellationToken)
        {
